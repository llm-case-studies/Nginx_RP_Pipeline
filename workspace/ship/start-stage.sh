#!/usr/bin/env bash
#-------------------------------------------------------------
# start-stage.sh - Self-contained stage environment deployment
...
ENVIRONMENT="stage"
DEPLOYMENT_ROOT="$(pwd)"
NETWORK_NAME="nginx-rp-network-stage"
CONTAINER_NAME="nginx-rp-stage"
VAULTWARDEN_NAME="vaultwarden-stage"

# Port Configuration
HTTP_PORT=8080
HTTPS_PORT=8443
VAULTWARDEN_PORT=8224

# Network Configuration  
NETWORK_SUBNET="172.21.0.0/16"
NGINX_IP="172.21.0.10"
VAULTWARDEN_IP="172.21.0.5"
