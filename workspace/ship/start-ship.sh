#!/usr/bin/env bash
#-------------------------------------------------------------
# start-ship.sh - Self-contained ship environment deployment
...
ENVIRONMENT="ship"
DEPLOYMENT_ROOT="$(pwd)"
NETWORK_NAME="nginx-rp-network-ship"
CONTAINER_NAME="nginx-rp-ship"
VAULTWARDEN_NAME="vaultwarden-ship"

# Port Configuration
HTTP_PORT=8083
HTTPS_PORT=8446
VAULTWARDEN_PORT=8223

# Network Configuration  
NETWORK_SUBNET="172.20.0.0/16"
NGINX_IP="172.20.0.10"
VAULTWARDEN_IP="172.20.0.5"
