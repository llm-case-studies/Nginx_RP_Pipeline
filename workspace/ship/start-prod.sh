#!/usr/bin/env bash
#-------------------------------------------------------------
# start-prod.sh - Self-contained prod environment deployment
...
ENVIRONMENT="prod"
DEPLOYMENT_ROOT="$(pwd)"
NETWORK_NAME="nginx-rp-network-prod"
CONTAINER_NAME="nginx-rp-prod"
VAULTWARDEN_NAME="vaultwarden-prod"
